          ...
          >
            <div className="w-96 h-72 p-2">
              <IndBox
                ...
                org={<div className="h-32 overflow-auto">Developed a financial AI agent designed to assist users in making intelligent, automated investment and budgeting decisions. The project leverages machine learning algorithms and predictive analytics to optimize personal finance management, providing insights into spending patterns, risk assessment, and portfolio optimization.</div>}
                color="#fbceb1"
                borderColor="#e0b594"
              />
            </div>
